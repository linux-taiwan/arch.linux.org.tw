...
2. 將此原始碼 <code>git clone</code> （因為我們引用了 Twitter Bootstrap，所以建議使用 <code>--recursive</code> 選項同時複製）到您的本地端之後，在原始碼根目錄下執行 `bundle install` 安裝必要的元件。（目前我們使用了 Jekyll 與 Compass）
